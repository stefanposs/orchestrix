...
from orchestrix.core.messaging.dead_letter_queue import DeadLetteredMessage, InMemoryDeadLetterQueue
...
class TestConcurrentAccess:
    ...
    async def test_async_store_concurrent_saves(self) -> None:
        ...
        for i in range(50):
            ...
            assert event.value == f"event-agg-{i}"
...
class TestInvalidInputs:
    ...
    def test_dlq_duplicate_message_ids(self) -> None:
        ...
        dlq.enqueue(DeadLetteredMessage(message=msg, reason="Error 1", failure_count=1))
        dlq.enqueue(DeadLetteredMessage(message=msg, reason="Error 2", failure_count=2))
...
class TestMessageImmutability:
    ...
    def test_message_in_dlq_cannot_be_modified(self) -> None:
        ...
        dead_lettered = DeadLetteredMessage(message=msg, reason="Failed", failure_count=1)
