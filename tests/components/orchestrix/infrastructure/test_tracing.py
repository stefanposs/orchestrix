...
class TestTracingConfig:
    ...
    def test_invalid_host(self) -> None:
        ...
        with pytest.raises(ValueError, match="jaeger_agent_host"):
            TracingConfig(service_name="test", jaeger_agent_host="")
...
class TestJaegerTracer:
    ...
    def test_span_with_attributes(self) -> None:
        ...
        with tracer.span("process_event", {"event_id": "evt-123", "type": "OrderCreated"}):
            pass
    ...
    def test_span_error_handling(self) -> None:
        ...
        with pytest.raises(ValueError), tracer.span("failing_operation"):
    ...
    async def test_async_span_with_attributes(self) -> None:
        ...
        async with tracer.async_span("async_process", {"operation": "create_order"}):
            pass
    ...
    def test_span_command_creation(self) -> None:
        ...
        with tracer.span_command(command_type="CreateOrder", aggregate_id="order-123"):
            pass
    ...
    async def test_async_span_command_creation(self) -> None:
        ...
        async with tracer.async_span_command(command_type="ConfirmOrder", aggregate_id="order-123"):
            pass
    ...
    async def test_async_span_saga_creation(self) -> None:
        ...
        async with tracer.async_span_saga(saga_type="OrderFulfillment", saga_id="saga-002"):
            pass
    ...
    def test_nested_spans(self) -> None:
        ...
        with tracer.span("parent_operation"), tracer.span("child_operation"):
            pass
    ...
    async def test_nested_async_spans(self) -> None:
        ...
        async with tracer.async_span("parent_async"), tracer.async_span("child_async"):
            pass
...
class TestTracingInitialization:
    ...
    def test_get_tracer(self) -> None:
        ...
        from orchestrix.infrastructure.observability.jaeger import get_tracer
