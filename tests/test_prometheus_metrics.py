...
class TestMetricConfig:
    ...
    def test_custom_config(self) -> None:
        ...
        config = MetricConfig(
            namespace="myapp", subsystem="orders", enable_summary_metrics=False
        )
...
class TestPrometheusMetrics:
    ...
    def test_track_storage_operation_success(self) -> None:
        ...
        with metrics.track_storage_operation(
            operation_type=MetricOperationType.APPEND
        ):
            pass  # Simulate successful operation
    ...
    def test_track_storage_operation_failure(self) -> None:
        ...
        with pytest.raises(IOError):
            with metrics.track_storage_operation(
                operation_type=MetricOperationType.LOAD
            ):
