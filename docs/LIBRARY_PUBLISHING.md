# Library Publishing Guide (PyPI)

> **⚠️ Note:** This guide describes the process of releasing the **Orchestrix library** to PyPI.
> For deploying applications built with Orchestrix, see the [Application Deployment Guide](deployment/APPLICATION_DEPLOYMENT.md).
